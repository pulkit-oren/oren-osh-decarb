  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        ...
        <KpiCard emphasis icon={TrendingDown} label="Blended cost of abatement" value={fmtPerTonne(k.costPerTonne)} unit="/tCO₂e" hint={`portfolio payback ${fmtPayback(k.paybackYears, k.paybackKind)}`} />
      </div>
